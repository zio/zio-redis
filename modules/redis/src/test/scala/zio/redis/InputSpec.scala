    ...
    suite("Input encoders")(
      ...
      suite("GetEx")(
        test("GetExInput - valid value") {
          ...
          } yield assert(resultSeconds)(equalTo(RespCommand(Key("key"), Literal("EX"), Unknown("1")))) &&
            assert(resultMilliseconds)(equalTo(RespCommand(Key("key"), Literal("PX"), Unknown("100")))) &&
            assert(resultUnixTimeSeconds)(equalTo(RespCommand(Key("key"), Literal("EXAT"), Unknown("1617667200")))) &&
