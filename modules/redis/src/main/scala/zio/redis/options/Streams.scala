...
trait Streams {
  ...
  sealed case class StreamClaimedEntries[SI, I, K, V](streamId: SI, entries: Chunk[StreamEntry[I, K, V]])

  sealed case class StreamClaimedIdChunk[SI, I](streamId: SI, claimedIds: Chunk[I])
