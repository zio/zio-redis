...
trait Connection {
   ...
   */
  final def auth(password: String): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def clientCaching(track: Boolean): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   */
  final def clientId: ZIO[RedisEnv, RedisError, Long] = {
   ...
   *   the Unit value.
   */
  final def clientKill(address: Address): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   */
  final def clientKill(filters: ClientKillFilter*): ZIO[RedisEnv, RedisError, Long] = {
   ...
   */
  final def clientGetName: ZIO[RedisEnv, RedisError, Option[String]] = {
   ...
   */
  final def clientGetRedir: ZIO[RedisEnv, RedisError, ClientTrackingRedirect] = {
   ...
   *   the Unit value.
   */
  final def clientUnpause: ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def clientSetName(name: String): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def clientTrackingOff: ZIO[RedisEnv, RedisError, Unit] = {
    val command = RedisCommand(ClientTracking, ClientTrackingInput, UnitOutput)
    command.run(None)
  }
   ...
   */
  final def clientTrackingInfo: ZIO[RedisEnv, RedisError, ClientTrackingInfo] = {
   ...
   *   the message.
   */
  final def echo(message: String): ZIO[RedisEnv, RedisError, String] = {
   ...
   */
  final def ping(message: Option[String] = None): ZIO[RedisEnv, RedisError, String] = {
   ...
   *   the Unit value.
   */
  final def quit: ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def reset: ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def select(index: Long): ZIO[RedisEnv, RedisError, Unit] = {
