...
trait Lists {
   ...
   */
  final def lLen[K: Schema](key: K): ZIO[RedisEnv, RedisError, Long] = {
   ...
   */
  final def lPush[K: Schema, V: Schema](key: K, element: V, elements: V*): ZIO[RedisEnv, RedisError, Long] = {
   ...
   *   the length of the list after the push operation.
   */
  final def lPushX[K: Schema, V: Schema](key: K, element: V, elements: V*): ZIO[RedisEnv, RedisError, Long] = {
   ...
   */
  final def lRem[K: Schema](key: K, count: Long, element: String): ZIO[RedisEnv, RedisError, Long] = {
   ...
   *   the Unit value.
   */
  final def lSet[K: Schema, V: Schema](key: K, index: Long, element: V): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the Unit value.
   */
  final def lTrim[K: Schema](key: K, range: Range): ZIO[RedisEnv, RedisError, Unit] = {
   ...
   *   the length of the list after the push operation.
   */
  final def rPush[K: Schema, V: Schema](key: K, element: V, elements: V*): ZIO[RedisEnv, RedisError, Long] = {
   ...
   *   the length of the list after the push operation.
   */
  final def rPushX[K: Schema, V: Schema](key: K, element: V, elements: V*): ZIO[RedisEnv, RedisError, Long] = {
  ...
  final def blPop[K: Schema](key: K, keys: K*)(
    ...
    new ResultBuilder1[({ type lambda[x] = Option[(K, x)] })#lambda] {
      def returning[V: Schema]: ZIO[RedisEnv, RedisError, Option[(K, V)]] = {
        val command = RedisCommand(
          BlPop,
  ...
  ): ZIO[RedisEnv, RedisError, Option[Long]] = {
    val command = RedisCommand(
      LPos,
      Tuple4(
        ArbitraryInput[K](),
  ...
  final def lPosCount[K: Schema, V: Schema](
    ...
    rank: Option[Rank] = None,
    maxLen: Option[ListMaxLen] = None
  ): ZIO[RedisEnv, RedisError, Chunk[Long]] = {
    val command = RedisCommand(
      LPos,
      Tuple5(
        ArbitraryInput[K](),
