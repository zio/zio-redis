...
trait Keys {
   ...
   *   [[unlink]]
   */
  final def del[K: Schema](key: K, keys: K*): ZIO[RedisEnvironment, RedisError, Long] = {
   ...
   */
  final def dump[K: Schema](key: K): ZIO[RedisEnvironment, RedisError, Chunk[Byte]] = {
   ...
   */
  final def exists[K: Schema](key: K, keys: K*): ZIO[RedisEnvironment, RedisError, Long] = {
   ...
   *   [[expireAt]]
   */
  final def expire[K: Schema](key: K, timeout: Duration): ZIO[RedisEnvironment, RedisError, Boolean] = {
   ...
   *   [[expire]]
   */
  final def expireAt[K: Schema](key: K, timestamp: Instant): ZIO[RedisEnvironment, RedisError, Boolean] = {
  ...
  ): ZIO[RedisEnvironment, RedisError, String] = {
   ...
   */
  final def move[K: Schema](key: K, destinationDb: Long): ZIO[RedisEnvironment, RedisError, Boolean] = {
   ...
   */
  final def persist[K: Schema](key: K): ZIO[RedisEnvironment, RedisError, Boolean] = {
   ...
   *   [[pExpireAt]]
   */
  final def pExpire[K: Schema](key: K, timeout: Duration): ZIO[RedisEnvironment, RedisError, Boolean] = {
    val command =
      RedisCommand(PExpire, Tuple2(ArbitraryInput[K](), DurationMillisecondsInput), BoolOutput)
    command.run((key, timeout))
  }
   ...
   *   [[pExpire]]
   */
  final def pExpireAt[K: Schema](key: K, timestamp: Instant): ZIO[RedisEnvironment, RedisError, Boolean] = {
    val command =
      RedisCommand(PExpireAt, Tuple2(ArbitraryInput[K](), TimeMillisecondsInput), BoolOutput)
    command.run((key, timestamp))
  }
   ...
   */
  final def pTtl[K: Schema](key: K): ZIO[RedisEnvironment, RedisError, Duration] = {
   ...
   */
  final def rename[K: Schema](key: K, newKey: K): ZIO[RedisEnvironment, RedisError, Unit] = {
   ...
   */
  final def renameNx[K: Schema](key: K, newKey: K): ZIO[RedisEnvironment, RedisError, Boolean] = {
  ...
  final def scan(
    ...
    new ResultBuilder1[({ type lambda[x] = (Long, Chunk[x]) })#lambda] {
      def returning[K: Schema]: ZIO[RedisEnvironment, RedisError, (Long, Chunk[K])] = {
        val command = RedisCommand(
          Scan,
   ...
   */
  final def touch[K: Schema](key: K, keys: K*): ZIO[RedisEnvironment, RedisError, Long] = {
   ...
   *   remaining time to live of a key that has a timeout, error otherwise.
   */
  final def ttl[K: Schema](key: K): ZIO[RedisEnvironment, RedisError, Duration] = {
   ...
   */
  final def typeOf[K: Schema](key: K): ZIO[RedisEnvironment, RedisError, RedisType] = {
   ...
   *   [[del]]
   */
  final def unlink[K: Schema](key: K, keys: K*): ZIO[RedisEnvironment, RedisError, Long] = {
   ...
   */
  final def wait_(replicas: Long, timeout: Duration): ZIO[RedisEnvironment, RedisError, Long] = {
