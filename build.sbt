...
lazy val example =
  project
    ...
    .settings(
      publish / skip := true,
      libraryDependencies ++= Seq(
        "com.softwaremill.sttp.client3" %% "async-http-client-backend-zio1" % "3.7.2",
        "com.softwaremill.sttp.client3" %% "zio1-json"                      % "3.7.2",
        "dev.zio"                       %% "zio-streams"                    % Zio,
        "dev.zio"                       %% "zio-config-magnolia"            % "2.0.5",
        "dev.zio"                       %% "zio-config-typesafe"            % "2.0.5",
        "dev.zio"                       %% "zio-schema-protobuf"            % "0.1.9",
